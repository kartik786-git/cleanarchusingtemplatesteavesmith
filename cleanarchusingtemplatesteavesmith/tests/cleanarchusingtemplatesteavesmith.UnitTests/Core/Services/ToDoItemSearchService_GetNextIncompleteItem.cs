...
using cleanarchusingtemplatesteavesmith.Core.ProjectAggregate;
using cleanarchusingtemplatesteavesmith.Core.Services;
using cleanarchusingtemplatesteavesmith.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace cleanarchusingtemplatesteavesmith.UnitTests.Core.Services
{
