...
using cleanarchusingtemplatesteavesmith.Infrastructure.Data;
using cleanarchusingtemplatesteavesmith.Infrastructure.Data.Queries;
using cleanarchusingtemplatesteavesmith.Infrastructure.Email;
using cleanarchusingtemplatesteavesmith.UseCases.Contributors.Create;
using cleanarchusingtemplatesteavesmith.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace cleanarchusingtemplatesteavesmith.Infrastructure;
/// <summary>
